...
class TableService {
  ...
  async createTable(tableData) {
    try {
      ...
      // Check if table number already exists in the same floor
      ...
      // Validate branch and floor exist
      ...
      // Check if floor belongs to the branch
      console.log('Comparing branch_id:', parseInt(floor.branch_id), 'with', parseInt(tableData.branch_id));
  ...
  async updateTable(id, tableData) {
    try {
      ...
      // Check if new table number conflicts with other tables in the same floor
      ...
      // Validate branch and floor if being updated
